    ...
    <div class="boxe">
      <div class="box0">
        <div class="statsD">
          ...
          <div class="stats1">
            ...
            <div class="valueD">5.2 seconds</div>
          </div>
          <div class="stats1">
          ...
          <div class="stats1">
            ...
            <div class="valueD">100,000,000</div>
          </div>
      ...
      <div class="boxes">
        <div class="box1">
          ...
          <div class="pools">
            <div class="vAddy1" id="pool5"><span style="color: #496785">5.</span> <div class="stian">StianNOR - EU</div><span style="color: #496785">Pool Fee:</span>
