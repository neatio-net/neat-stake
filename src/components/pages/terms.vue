<template>
    <div class="dashboard">
        ...
        `TERMS AND CONDITIONS`, 
          ...
          and its subdomains “wallet.neatio.net”,
          “scan.neatio.net”, "blog.neatio.net" as well as any other media form, media
          ...
          the subdomains “wallet.neatio.net” and “scan.neatio.net” website are
