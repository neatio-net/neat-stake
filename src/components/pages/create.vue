      ...
      <div class="boxe">
        <div class="boxes">
          <div class="boxw">
            ...
            <div class="locked">Unencrypted PrivKey</div>
     
            <router-link to="/createpk"><button class="ripp">PrivateKey</button></router-link>
          </div>
          <div class="boxw">
            <div class="lockked">
            ...
            <div class="locked">KeyStore + Password</div>
            <router-link to="/createks"><button class="ripp">KeyStore</button></router-link>
          </div>
        </div>
        <div v-if="step == 1">
